<template>
	<view class="setUpInfo">
		...
		<view class="setUpInfos flexAB">
			收费价格
			<input type="number" v-model="form.price" class="setUpInfosInput" placeholder="请输入收费价格">
		</view>
		<view class="setUpInfos flexAB">
			每日接单数量限制
			<input type="number" inputmode="numeric" @input="inputContent" v-model="form.count" class="setUpInfosInput" placeholder="请输入每日接单数量限制">
		</view>
		<!-- <view class="setUpInfos flexAB">
			过期时间
			<view class="flexA">
