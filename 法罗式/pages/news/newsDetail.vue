<template>
	<view class="content">
		...
		<view style="margin-left: 20rpx;margin-top: 40rpx;">法罗适  {{date}}</view>
...
<script>
	export default {
		...
		onLoad(option) {
			console.log(option.imgPath)
			console.log(option.contentTitle)
			this.contentTitle = option.contentTitle
