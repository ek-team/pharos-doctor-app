<template>
	<view class="inputCompont">
		...
		<view class="inputInfo">
			...
			<view class="radioInfo flexA" v-for="(item,index) in form.formOptionsList" :key="index">
				<image src="/static/images/icon_chos@3x.png" mode="" class="radioInfoicon"></image>
				{{item.text}}
			</view>
		</view>
		<view class="tips">
		...
		<view class="isMust optionContent"  v-for="(item,index) in form.formOptionsList" :key="index">
			<view class="flexAB">
				<input type="text" placeholder="输入选项" v-model="item.text" class="raiodInfo">
